...
function tax_treaty(){
	...
	}else{// any visatypes other than student
    	line6 = 0
	...
	if(line6==0){
		...
		linej = " Line J: Tax Exemption based on Tax Treaty, on wages during Studying and Training: $"+line6+" based on Article: "+article ;
	}
	wages="Line 6: Total Wages and Scholarship exempt by a Treaty  $"+line6;
	document.getElementById("output").innerHTML =wages+"<br>"+linej;
