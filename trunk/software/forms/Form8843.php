...
$fields["f1_01(0)"]->setValue($_POST[fname]);
$fields["f1_02(0)"]->setValue($_POST[lname]);
$fields["f1_03(0)"]->setValue($_POST[ssn_itin]);
$fields["f1_04(0)"]->setValue($_POST[line1]);
$fields["f1_010(0)"]->setValue($_POST[line2]);
